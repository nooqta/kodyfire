...
class Package {
  ...
  static getInstalledKodiesName(dirname = process.cwd()) {
    ...
    const packages = packageJson.dependencies
      ? Object.keys(packageJson.dependencies).filter(
          _package => _package.indexOf('-kodyfire') > -1
        )
      : [];
    return _.merge(
      packages,
  ...
  static getInstalledKodiesFromPath(dirname) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const packages = Package.getInstalledKodiesName(dirname);
      for (const _package of packages) {
        const { isValid, packageInfo } = yield this.getPackageInfo(
          _package,
          dirname
        );
        if (isValid) kodies.push(packageInfo);
    ...
    return __awaiter(this, void 0, void 0, function* () {
      try {
        const { isValid, packageJson, packageInfo } =
          yield Package.getPackageInfo(_package);
        if (isValid) {
  ...
  static getPackageInfo(_package, dirname = process.cwd()) {
    return __awaiter(this, void 0, void 0, function* () {
      const packageJson = yield this.getPackageJson(
