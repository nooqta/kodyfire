...
function multiStepInput(context) {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    const createResourceGroupButton = new MyButton(
      {
        dark: vscode_1.Uri.file(
          context.asAbsolutePath('resources/dark/add.svg')
        ),
        light: vscode_1.Uri.file(
          context.asAbsolutePath('resources/light/add.svg')
        ),
      },
    ...
    function inputResourceGroupName(input, state) {
      return __awaiter(this, void 0, void 0, function* () {
        state.resourceGroup = yield input.showInputBox({
          ...
          totalSteps: 4,
          value:
            typeof state.resourceGroup === 'string' ? state.resourceGroup : '',
    ...
    function pickRuntime(input, state) {
      return __awaiter(this, void 0, void 0, function* () {
        const additionalSteps = typeof state.resourceGroup === 'string' ? 1 : 0;
        const runtimes = yield getAvailableRuntimes(
          state.resourceGroup,
    ...
    function getAvailableRuntimes(_resourceGroup, _token) {
      return __awaiter(this, void 0, void 0, function* () {
        // ...retrieve...
        yield new Promise(resolve => setTimeout(resolve, 1000));
            ...
            input.onDidHide(() => {
              (() =>
                __awaiter(this, void 0, void 0, function* () {
                  reject(
                    shouldResume && (yield shouldResume())
