...
const route = {
  ...
  properties: {
    ...
    template: {
      type: 'string',
      description:
        'The template of the route file. This is the corrresponding file for the name property',
...
const navigation = {
  ...
  properties: {
    layout: {
      type: 'string',
      description:
        'The layout of the navigation. Vuexy uses the layout to render the navigation',
      ...
      items: {
        ...
        properties: {
          ...
          icon: {
            type: 'string',
            description:
              'The icon of the route. This is used to render the icon of the route',
          ...
          resource: {
            type: 'string',
            description:
              'The resource of the route. Used as guard along action',
          },
          action: {
            type: 'string',
            description:
              'The action of the route. Used as guard along resource',
...
const baseModule = {
  ...
  properties: {
    ...
    templateFolder: {
      ...
      description:
        'The template folder of the module. These are the available boilerplates for module',
      default: 'module',
    },
    data: {
      type: 'object',
