...
function action(args) {
    return __awaiter(this, void 0, void 0, function* () {
        const { collection: collectionName, schematic: schematicName } = parseSchematicName(args);
...
module.exports = (program) => {
    program
        ...
        try {
            action(Object.assign(Object.assign({}, _opt), { schematic: 'scaffold', dryRun: false }));
        }
        catch (error) {
            console.log(error);
        }
