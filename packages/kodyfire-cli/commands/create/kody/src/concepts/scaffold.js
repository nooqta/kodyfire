            ...
            for (const file of folderContent) {
                ...
                try {
                    if (stat.isFile()) {
                        ...
                        yield this.engine.createOrOverwrite(this.technology.rootDir, _data.outputDir, this.getFilename(_data.templateFolder.replace(this.technology.params.templateFolder, ''), file), compiled);
                    }
