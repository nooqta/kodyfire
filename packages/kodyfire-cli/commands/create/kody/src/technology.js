...
class Technology {
    ...
    prepareConcept(dependency, conceptName, preparedConcept) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a;
            const { schema } = yield (_a = `${process.cwd()}/node_modules/${dependency}`, Promise.resolve().then(() => __importStar(require(_a))));
            ...
            for (const requirement of requirements) {
                ...
                // }
                preparedConcept = Object.assign(Object.assign({}, preparedConcept), { [requirement]: conceptSchema.items.properties[requirement].default || '' });
            }
