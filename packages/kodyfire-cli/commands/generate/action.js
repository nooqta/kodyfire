        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            (() => __awaiter(this, void 0, void 0, function* () {
                do {
                    ...
                    let kodyName = _kodyName, conceptName = _conceptName;
                    ...
                    if (!this.properties) {
                        // set properties
                        const answers = yield this.getPropertiesAnswers(currentConcept, Object.assign({ name }, defaults));
                        if (answers) {
                            // @todo validate answers
                            yield this.generateConcept(this.kody, this.concept, answers);
                            // if persist is true we save the data
                            if (includes && includes.length > 0) {
                                includes = includes.filter((include) => include !== this.concept);
                                const concepts = yield this.getDependencyConcepts(this.kody);
                                const skipped = includes.filter((include) => !concepts[include]);
                                includes = includes.filter((include) => concepts[include]);
                                if (skipped.length > 0) {
                                    console.log(`${chalk_1.default.dim(`The following concepts were skipped: ${skipped.join(', ')}`)}`);
                                }
                                yield this.generateIncludes(this.kody, includes, {
                                    name: answers['name'],
                                });
                            }
                            this.displayMessage(chalk_1.default.green(`🙌 ${chalk_1.default.bold([conceptName, ...includes].join(', '))} ${chalk_1.default.white('created successfully')}`), 'green');
                            if (persist) {
    ...
    static generateIncludes(kody, includes, rootConcept) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const include of includes) {
                ...
                this.concept = conceptName !== null && conceptName !== void 0 ? conceptName : include;
                const currentConcept = yield this.getCurrentConcept();
                const answers = yield this.getPropertiesAnswers(currentConcept, { name });
    ...
    static addConcept(dependency, concept, data, rootDir = process.cwd()) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                this.displayMessage(chalk_1.default.green(`🙌 ${chalk_1.default.bold(concept)} ${chalk_1.default.white('created successfully')}`), 'green');
            }
            catch (error) {
                this.displayMessage(error.message);
            }
    ...
    static generateConcept(dependency, concept, data, rootDir = process.cwd()) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const m = yield (_a = path, Promise.resolve().then(() => __importStar(require(_a))));
