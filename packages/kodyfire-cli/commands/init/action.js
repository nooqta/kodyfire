            ...
            try {
                ...
                if (dependencies.length > 0) {
                    for (const dep of dependencies) {
                        ...
                        const { schema } = yield Promise.resolve().then(() => __importStar(require(`${_args.rootDir}/node_modules/${dep}`)));
                        ...
                        fs.writeFileSync((0, path_1.join)(_args.rootDir, `kody-${dep.replace('-kodyfire', '')}.json`), kodyJson);
                    }
