...
class Action {
    ...
    static getEntries(rootDirectory, dep) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { schema } = yield Promise.resolve().then(() => __importStar(require(`${rootDirectory}/node_modules/${dep}`)));
    ...
    static getDependencyConcepts(dependency, rootDir = process.cwd()) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const entries = {};
                // get the deb package schema file
                const { schema } = yield Promise.resolve().then(() => __importStar(require(`${rootDir}/node_modules/${dependency}`)));
                for (const prop of Object.keys(schema.properties)) {
