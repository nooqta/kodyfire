...
const watchFile = (source, kodyName, build = false) => __awaiter(void 0, void 0, void 0, function* () {
    console.log(`Watching for file changes on ${source} for kody ${kodyName}`);
    fs_1.default.watchFile(source, (_event, filename) => __awaiter(void 0, void 0, void 0, function* () {
        if (filename) {
            if (build) {
